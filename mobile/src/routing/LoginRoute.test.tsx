...
describe(
  ...
  () => {
    ...
    it(
      'muestra confirmación cuando el registro terminó correctamente',
      async () => {
        render(
          <TestApp
            initialEntry="/login?registered=1"
          />,
        );
    ...
    it(
      'conserva un destino protegido válido como estado de aplicación',
      async () => {
        render(
          <TestApp
    ...
    it(
      'regresa a gestión después de login correcto',
      async () => {
        vi.mocked(
          zamoraFestApi.login,
    ...
    it(
      'regresa a creación cuando el ASISTENTE solicitó la ruta anidada',
      async () => {
        vi.mocked(
          zamoraFestApi.login,
        ).mockResolvedValueOnce(
    ...
    it(
      'rechaza un redirect externo y utiliza una ruta pública segura',
      async () => {
        vi.mocked(
          zamoraFestApi.login,
        ).mockResolvedValueOnce(
    ...
    it(
      'mantiene la sesión cuando el usuario carece del rol ASISTENTE',
      async () => {
        vi.mocked(
          zamoraFestApi.login,
        ).mockResolvedValueOnce(
